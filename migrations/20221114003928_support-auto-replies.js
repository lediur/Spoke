...
exports.up = function up(knex) {
  return knex.schema.raw(`
    ...
    -- set existing contacts as not eligible
    alter table campaign_contact
      add column is_auto_reply_eligible boolean not null default false;
    -- then let future contacts be eligible by default
    alter table campaign_contact
      alter column is_auto_reply_eligible set default true;
  `);
};
